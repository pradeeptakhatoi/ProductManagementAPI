...
if (1 || isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST'] == 'localhost') {
    ...
    define('DB_HOSTNAME', "localhost");
    define('DB_USERNAME', "devraddyx");
    define('DB_PASSWORD', "root"); 
    define('DB_NAME', "zadmin_product_management");
    define('DEBUG', true);
}
...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '9c8374d21e6fbab979c0c218fba5dc2082b454fca46b74669ff7bd20d08e28c0'),
    ],
